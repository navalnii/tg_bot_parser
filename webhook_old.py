...
WEBHOOK_HOST = os.environ['HOST']  # Domain name or IP addres which your bot is located.
...
async def on_startup(app):
    ...
    dp.register_message_handler(cancel, state='*')

    dp.register_message_handler(cmd_id, commands=['id'], state='*')
    dp.register_message_handler(cmd_id, state='*')
